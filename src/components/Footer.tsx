...
export default function Footer() {
  ...
  return (
    <footer>
      <div className='bg-purple-800 flex flex-col items-center gap-6 bg-cover py-20 bg-[url(/images/bg-boost-mobile.svg)] desktop:bg-[url(/images/bg-boost-desktop.svg)]'>
        <h1 className='text-[1.75rem] desktop:text-[2.5rem] text-white font-bold text-center'>
          Boost your links today
        </h1>
        <StartedBtn />
      </div>
      <div className='flex desktop:items-start desktop:grid desktop:grid-cols-3 py-12 flex-col items-center gap-12 text-center bg-[#232127]'>
        <svg
        ...
        <div className='desktop:flex desktop:gap-10 space-y-10'>
          {footerLinks.map((section) => (
            <div
              className='flex flex-col desktop:text-left space-y-1.5'
              key={section.title}>
              <p className='text-white mb-4 font-bold'>{section.title}</p>
              {section.links.map((link) => (
                <a
                  className='text-white desktop:hover:text-lightBlue'
                  key={link}
                  href='#'>
                  {link}
                </a>
