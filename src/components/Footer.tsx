...
export default function Footer() {
  ...
  return (
    <footer>
      <div className='bg-purple-800 flex flex-col items-center gap-6 py-20 bg-[url(/images/bg-boost-mobile.svg)] desktop:bg-[url(/images/bg-boost-desktop.svg)]'>
        <h1 className='text-[1.75rem] text-white font-bold text-center'>
          Boost your links today
        </h1>
        <StartedBtn />
      </div>
      <div className='flex py-12 flex-col items-center gap-12 text-center bg-[#232127]'>
        ...
        <div className='space-y-10'>
          {footerLinks.map((section) => (
            <div className='flex flex-col space-y-1.5' key={section.title}>
              <p className='text-white mb-4 font-bold'>{section.title}</p>
              {section.links.map((link) => (
                <a className='text-white' key={link} href='#'>
                  {link}
                </a>
              ))}
            </div>
