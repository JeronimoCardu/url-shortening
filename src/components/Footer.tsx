...
export default function Footer() {
  ...
  return (
    <footer>
      <div className="desktop:bg-[url(/images/bg-boost-desktop.svg)] flex flex-col items-center gap-6 bg-purple-800 bg-[url(/images/bg-boost-mobile.svg)] bg-cover py-20">
        <h1 className="desktop:text-[2.5rem] text-center text-[1.75rem] font-bold text-white">
          Boost your links today
        </h1>
        <StartedBtn />
      </div>
      <div className="desktop:items-start desktop:grid desktop:grid-cols-3 flex flex-col items-center gap-12 bg-[#232127] py-12 text-center">
        <svg
          className="desktop:self-start desktop:justify-self-center"
        ...
        <div className="desktop:flex desktop:gap-10 space-y-10">
          {footerLinks.map((section) => (
            <div
              className="desktop:text-left flex flex-col space-y-1.5"
              key={section.title}
            >
              <p className="mb-4 font-bold text-white">{section.title}</p>
              {section.links.map((link) => (
                <a
                  className="desktop:hover:text-lightBlue text-white"
                  key={link}
                  href="#"
                >
                  {link}
